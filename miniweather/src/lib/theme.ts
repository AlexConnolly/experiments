...
const THEMES: Record<Condition, { day: Theme; night: Theme }> = {
  ...
  cloudy: {
    day: {
      ...
      clouds: { color: '#e9eef3', count: 15, opacity: 0.96 },
      snowGround: false,
      wet: false,
    },
    night: {
      ...
      clouds: { color: '#2c3550', count: 15, opacity: 0.95 },
      snowGround: false,
      wet: false,
    },
  },
  ...
  drizzle: {
    day: {
      ...
      clouds: { color: '#dbe3ea', count: 12, opacity: 0.95 },
      snowGround: false,
      wet: true,
    },
    night: {
      ...
      clouds: { color: '#262f47', count: 12, opacity: 0.95 },
      snowGround: false,
      wet: true,
    },
  },
  rain: {
    day: {
      ...
      clouds: { color: '#c3ccd6', count: 15, opacity: 0.97 },
      snowGround: false,
      wet: true,
    },
    night: {
      ...
      clouds: { color: '#202840', count: 15, opacity: 0.96 },
      snowGround: false,
      wet: true,
    },
  },
  snow: {
    day: {
      ...
      clouds: { color: '#e8edf2', count: 12, opacity: 0.92 },
      snowGround: true,
      wet: false,
    },
    night: {
      ...
      clouds: { color: '#323d5c', count: 12, opacity: 0.92 },
      snowGround: true,
      wet: false,
    },
  },
  thunder: {
    day: {
      ...
      clouds: { color: '#828f9f', count: 17, opacity: 0.98 },
      snowGround: false,
      wet: true,
    },
    night: {
      ...
      clouds: { color: '#181f33', count: 17, opacity: 0.97 },
      snowGround: false,
      wet: true,
    },
  },
